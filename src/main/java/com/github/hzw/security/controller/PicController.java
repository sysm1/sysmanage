...
public class PicController extends BaseController{
	...
	public String getPic(HttpServletRequest request,HttpServletResponse response) throws Exception {
		String id=request.getParameter("id");
		SampleInput bean=sampleInputService.getById(id);
        FileInputStream hFile = new FileInputStream(bean.getPicture()); // 以byte流的方式打开文件 d:\1.gif   
