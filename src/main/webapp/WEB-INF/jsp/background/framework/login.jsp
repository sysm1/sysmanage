    ...
    <div class="box png">
		...
		<div class="input">
			...
			action="${pageContext.servletContext.contextPath }/submitlogin.html">
				<div class="name">
					<label>用户名</label><input type="text" class="text" id="username" value="root" placeholder="用户名" name="username" tabindex="1">
				</div>
				<div class="pwd">
					<label>密　码</label><input type="password" class="text" id="password" placeholder="密码" name="password" value="root" tabindex="2">
