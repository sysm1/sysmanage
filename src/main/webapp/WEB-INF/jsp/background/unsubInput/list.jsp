	...
	$(function() {
		grid = window.lanyuan.ui.lyGrid({
					...
					l_column : [ {
						...
						colkey : "qualityProblem",
						name : "客户质量反映问题"
					}],
					jsonUrl : '${pageContext.request.contextPath}/background/unsubInput/query.html',
					checkbox : true
				});
		...
		<div class="search" >
			...
			<table>
				<tr>
					...
					<td>
						<input type="text" id="unsubdates" name="unsubdates" value="<fmt:formatDate value='${bean.startDate}' pattern='yyyy-MM-dd'/>" style="width:91px;" 
							onfocus="WdatePicker({isShowClear:true,readOnly:true,maxDate:'%y-%M-%d'})">至
						<input type="text" id="unsubdatee" name="unsubdatee" value="<fmt:formatDate value='${bean.endDate}' pattern='yyyy-MM-dd'/>" style="width:91px;"
					...
					<td><input type="text" id="qualityProblem" name="qualityProblem" value=""></td>
				</tr>
			</table>
