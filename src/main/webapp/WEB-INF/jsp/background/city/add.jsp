...
<body>
<div class="divdialog">
	<div class="l_err" style="width: 330px;"></div>
	<form name="form" id="form" action="${ctx}/background/city/add.html" method="post">
		<table style="width: 330px; height: 100%;" class="datasearch">
			<tbody>
				<tr>
				...
				<tr>
					...
					<td style="text-align: left;">
						<input type="radio" id="status1" checked="checked" name="status" value="1">正常
						<input type="radio" id="status1" name="status" value="2">停用
					</td>
				</tr>
				<tr>
					<td colspan="2">
