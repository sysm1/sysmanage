	...
	<form name="form" id="form" action="${ctx}/background/diaobo/add.html" method="post">
		...
		<table style="width: 400px; height: 100%;" border="1" class="dataintable">
			...
			<tr>
				...
				<td style="text-align: left;">
					<div class="lanyuan_input">
						<input type="text" id="riqi" name="riqi" value="${today}" 
			...
			<tr id="textAllowance">
				...
				<td style="text-align: left;" nowrap="nowrap" style="width: 290px;">
					<input id='numKg' name="numKg" type="text" class="isNum" value="" >
				</td>
			</tr><tr>
				...
				<td style="text-align: left;">
					<textarea rows="4" style="width: 90%" id='mark' name="mark"></textarea>
				</td>
			</tr><tr>
				<td colspan="2">
