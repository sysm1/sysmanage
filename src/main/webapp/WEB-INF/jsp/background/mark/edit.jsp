...
<div class="divdialog">
	...
	<form name="form" id="form" action="${ctx}/background/mark/update.html" method="post">
			...
			<tbody>
				<tr>
					...
					<div class="lanyuan_input">
						<textarea rows="3" cols="30" id='content' name="content">${mark.content }</textarea>
					</div>
					</td>
				</tr>
				<tr>
