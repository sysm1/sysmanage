...
<script type="text/javascript">
	...
	$(function() {
		grid = window.lanyuan.ui.lyGrid({
					...
					jsonUrl : '${pageContext.request.contextPath}/background/printsummary/queryPrint.html',
					checkbox : true
				});
		...
		$("#add").click("click", function() {//绑定查询按扭
			dialog = parent.$.ligerDialog.open({
				width : 400,
				height : 510,
				url : rootPath + '/background/printsummary/addUI.html',
				title : "增加坯布余量",
		...
		$("#editView").click("click", function() {//绑定查询按扭
			...
			dialog = parent.$.ligerDialog.open({
				width : 300,
				height : 310,
				url : rootPath + '/background/printsummary/editUI.html?id='+cbox,
				title : "修改坯布余量",
				isHidden : false
			});
		});
			...
			parent.$.ligerDialog.confirm('删除后不能恢复，确定删除吗？', function(confirm) {
				if (confirm) {
					$.ajax({
					    ...
					    url: rootPath + '/background/printsummary/deleteById.html', //要访问的后台地址
		...
		<div class="search">
			<form name="fenye" id="fenye">
				<a class="btn btn-primary"
					href="javascript:void(0)" id="seach"> 打印
				</a>
				<a class="btn btn-primary"
					href="javascript:void(0)" id="seach1"> 刷新
				</a>
			</form>
		</div>
		<div class="topBtn">
