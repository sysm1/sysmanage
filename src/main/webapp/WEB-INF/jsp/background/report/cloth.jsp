...
$(function() {
	...
	$("#search").click("click", function() {//绑定查询按扭
		...
		f.attr('action','${pageContext.request.contextPath}/background/report/exportCloth.html');
		f.submit();
	});
			...
			<form name="fenye" id="fenye">
				...
				<table>
					<tr>
						...
						至
						<input type="text" name="endTime" style="width:100px;" onfocus="WdatePicker({isShowClear:true,readOnly:true})"/></td>
						<td>布种:
			...
			<table id="mytable" class="pp-list table table-striped table-bordered" style="margin-bottom: -3px;">
				<thead>
					<tr style="line-height:27px;">
						...
						<td style="text-align:center;display: ;">工厂</td>
